...
namespace Msg {
	...
	enum {
		...
		ERR_FETCH_DNS_FAILURE			= 9504,
		ERR_FETCH_MAX_PIPELINING_SIZE	= 9505,
		ERR_FETCH_MAX_PENDING_SIZE		= 9506,
		ERR_FETCH_CLIENT_REQUESTED		= 9507,
		ERR_FETCH_TRUNCATED_RESPONSE	= 9508,
	};
}
